...
def generatePlot(ma1, ma2, ticker):
    ...
    plt.title(ticker)
    plt.legend()
    plt.savefig(os.path.join(my_dir, 'Semester_2/flask-simcorp-ml/static/images/mac.png'))
...
def multiStock(ticker1, ticker2, ticker3, ticker4, from_date, to_date):
    ...
    plt.savefig(os.path.join(my_dir, 'Semester_2/flask-simcorp-ml/static/images/scatter.png'))
    ...
    plt.savefig(os.path.join(my_dir, 'Semester_2/flask-simcorp-ml/static/images/heatmap.png'))
    ...
    plt.savefig(os.path.join(my_dir, 'Semester_2/flask-simcorp-ml/static/images/riskreturn.png'))
...
def forecast(ma1, ma2, ticker, from_date, to_date):
    ...
    plt.savefig(os.path.join(my_dir, 'Semester_2/flask-simcorp-ml/static/images/predict.png'))
    plt.close()
